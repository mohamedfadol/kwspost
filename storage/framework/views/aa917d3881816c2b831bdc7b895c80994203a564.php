                        ...
                        <form action="<?php echo e(route('posts.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-sm" id="title" placeholder="Enter Post Title">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="files[]" class="form-control form-control-sm"  id="multiImg" multiple>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label for="compose-textarea"><?php echo e(__('message.Post Short Description')); ?></label>
                                    <textarea  name="short_description" class="form-control "
                                        id="compose-textarea"   style="height: 300px"></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="long_description" class="form-control"
                                        id="compose-textarea" id="long_description" style="height: 300px"></textarea>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kwspost\resources\views\posts\create.blade.php ENDPATH**/ ?>