      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            ...
            <a href="<?php echo e(route('webSetting.index')); ?>" class="btn btn-primary btn-block mb-3"><?php echo e(__('message.Back')); ?></a>
                <div class="card">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-9">
                ...
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('message.Update')); ?>  &nbsp;   <?php echo e($Kwspost->title); ?> </h3>
                    <div class="float-right">
                    <button type="submit"
                        class="btn btn-success">
                            <i class="fas fa-pencil-alt"></i> <?php echo e(__('message.Update')); ?></button>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="<?php echo e($Kwspost->title); ?>" class="form-control" id="title" />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="btn btn-primary col start btn-file">
                    ...
                    <input type="file" name="logo" id="file" value="<?php echo e($Kwspost->logo); ?>">
                </div>
